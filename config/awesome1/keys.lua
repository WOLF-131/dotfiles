...
keys.globalkeys = gears.table.join(
    ...
    awful.key({ superkey }, "r",
        function () awful.spawn("rofi -show drun -theme ~/.config/rofi/config/launcher.rasi") end,
        {description = "open Launcher menu", group = "awesome"}),
    -- Web search
    ...
    function() awful.spawn("brightnessctl s +10%") end, {description = "+10% brightness",   group = "brightness"}),
    awful.key({},           "XF86MonBrightnessDown",
    function() awful.spawn("brightnessctl s 10%-") end, {description = "-10% brightness",   group = "brightness"}),
    awful.key({superkey, }, "XF86MonBrightnessDown",
    function() awful.spawn("brightnessctl s 5%") end,   {description = "5% brightness",     group = "brightness"}),
    ...
    function()  awful.spawn("amixer set Master 5%+") end,   {description = "+5% volume",            group = "volume"}),
    awful.key({},           "XF86AudioLowerVolume",
    function() awful.spawn("amixer set Master 5%-") end,    {description = "-5% volume",            group = "volume"}),
    awful.key({superkey, }, "XF86AudioRaiseVolume",
    function() awful.spawn("amixer set Master 2%+") end,    {description = "+1% volume",            group = "volume"}),
    awful.key({superkey, }, "XF86AudioLowerVolume",
    function() awful.spawn("amixer set Master 2%-") end,    {description = "-1% volume",            group = "volume"}),
    awful.key({},           "XF86AudioMute",
    function() awful.spawn("amixer set Master toggle") end, {description = "mute volume",           group = "volume"}),

    -- Player Controll
    awful.key({},           "XF86AudioPlay",
    function() awful.spawn("playerctl play-pause") end,     {description = "play/pause player",     group = "volume"}),
    awful.key({},           "XF86AudioNext",
    function() awful.spawn("playerctl next") end,           {description = "player next",           group = "volume"}),
    awful.key({},           "XF86AudioPrev",
    function() awful.spawn("playerctl previous") end,       {description = "player prev",           group = "volume"}),

    -- MPD Controll
    awful.key({ shiftkey }, "XF86AudioPlay",
    function() awful.spawn("mpc -q toggle") end,            {description = "mpd toggle pause/play", group = "volume"}),
    awful.key({ shiftkey }, "XF86AudioNext",
    function() awful.spawn("mpc -q next") end,              {description = "mpd next song",         group = "volume"}),
    awful.key({ shiftkey }, "XF86AudioPrev",
    function() awful.spawn("mpc -q prev") end,              {description = "mpd previous song",     group = "volume"}),
