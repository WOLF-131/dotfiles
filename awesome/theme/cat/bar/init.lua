...
local color = require("theme.cat.theme.colors")
local utils = require("theme.cat.bar.utils")

local dpi = xresources.apply_dpi

local widgets = {
  get_taglist    = require("theme.cat.bar.modules.tags"),
  get_tasklist   = require("theme.cat.bar.modules.tasks"),
  get_layoutbox  = require("theme.cat.bar.modules.layoutbox"),

  clock          = require("theme.cat.bar.modules.clock"),
  volume         = require("theme.cat.bar.modules.volume"),
  battery        = require("theme.cat.bar.modules.battery"),
  brightness     = require("theme.cat.bar.modules.brightness"),

  power          = require("theme.cat.bar.modules.power"),
  dashboard      = require("theme.cat.bar.modules.dashboard"),
}
