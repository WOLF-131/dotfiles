...
menubar.utils.terminal = user_vars.terminal
...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({ modkey, "Control" }, "Down",
              function () awful.client.relative_move( 0, 0, 0, -20) end),
    awful.key({ modkey, "Control" }, "Up",
              function () awful.client.relative_move( 0, 0, 0,  20) end),
    awful.key({ modkey, "Control" }, "Left",
              function () awful.client.relative_move( 0, 0, -20, 0) end),
    awful.key({ modkey, "Control" }, "Right",
              function () awful.client.relative_move( 0, 0,  20, 0) end),

    -- Move
    awful.key({ modkey, "Shift" }, "Down",
              function () awful.client.relative_move( 0, 20, 0,  0) end),
    awful.key({ modkey, "Shift" }, "Up",
              function () awful.client.relative_move( 0, -20, 0, 0) end),
    awful.key({ modkey, "Shift" }, "Left",
              function () awful.client.relative_move( -20, 0, 0, 0) end),
